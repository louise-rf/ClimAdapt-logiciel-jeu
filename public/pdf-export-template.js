(function () {
  ...
  function buildClimAdaptExportHtml(payload) {
    ...
    const introZeroHtml = `<tr><td dir="ltr" class="ers-fs-213" style="font-size:21.3px;font-weight:700;font-family:Lato, Arial, Helvetica, sans-serif;text-align:left;padding:0px 24px 16px;line-height:1.4;mso-line-height-alt:29.8px"><span style="background-color:#99ff99;white-space:pre-wrap">0.</span><span style="white-space:pre-wrap"> Un contexte : l’urgence de l’adaptation</span><br></td></tr><tr><td dir="ltr" style="font-size:16px;font-family:Lato, Arial, Helvetica, sans-serif;text-align:left;padding:0px 24px 16px;line-height:1.4;mso-line-height-alt:22.4px"><span style="white-space:pre-wrap">Les impacts du changement climatique sur l’ensemble de notre société sont de plus en plus visibles. Face à une société encore insuffisamment préparée, leurs conséquences se répercutent à tous les niveaux : hausse du coût des sinistres, fragilisation du système assurantiel, ou encore augmentation des décès liés aux événements climatiques extrêmes.</span><br></td></tr><tr><td dir="ltr" style="font-size:16px;font-family:Lato, Arial, Helvetica, sans-serif;text-align:left;padding:0px 24px 16px;line-height:1.4;mso-line-height-alt:22.4px"><span style="white-space:pre-wrap">S’adapter est donc une nécessité : le coût de l’inaction </span><span style="font-weight:700;white-space:pre-wrap">sera toujours supérieur à celui de l’adaptation.</span><br></td></tr><tr><td style="padding:0px 24px 16px"><table cellpadding="0" cellspacing="0" border="0" style="width:100%"><tbody><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:552px"><tbody><tr><td height="2" style="height:2px;border-radius:999px;line-height:2px;mso-line-height-rule:exactly;font-size:0;background-color:#99ff99">&nbsp;</td></tr></tbody></table></td></tr></tbody></table></td></tr>`;
    const html = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preload" as="image" href="images/152b7731fe605e6f981b4b368190ab71.png"><link rel="preload" as="image" href="images/bbb6c7da7088c40139226704e546ff6c.png"><link rel="preload" as="image" href="images/a1f3f447961c6903f1f87104487678b0.png"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="format-detection" content="telephone=no, date=no, address=no, email=no"><meta name="x-apple-disable-message-reformatting"><meta name="keywords" content="DAHR_UmtG5M, BAFftZ2lh3s"><style>body{margin:0;padding:0}table{mso-table-lspace:0;mso-table-rspace:0}p,span,h1,h2,h3,h4,h5,h6{margin:0;padding:0}p{line-height:inherit}a[x-apple-data-detectors]{color:inherit!important;text-decoration:inherit!important}#MessageViewBody a{color:inherit;text-decoration:none}img+div{display:none}@media (max-width:599px){.ecw{width:100%!important;min-width:0!important}}</style><!--[if mso]><div>
                <noscript>
                  <xml>
...
<script>(function(){function c(){var b=Array.prototype.slice.call(document.images||[]);if(!b.length){return Promise.resolve()}return Promise.all(b.map(function(d){if(d.complete){return Promise.resolve()}return new Promise(function(e){var f=function(){e()};d.addEventListener("load",f,{once:true});d.addEventListener("error",f,{once:true});window.setTimeout(f,2500)})}))}function a(){window.setTimeout(function(){window.focus();window.print()},200)}window.addEventListener("load",function(){c().then(function(){if(document.fonts&&document.fonts.ready){document.fonts.ready.then(a);return}a()})})})();</script></body></html>`;
    ...
    const printStyles = `<style>@page{size:A4;margin:6mm}html,body{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;color-adjust:exact!important}img{max-width:100%;height:auto}.export-avoid-break{break-inside:avoid;page-break-inside:avoid}.export-break-before{break-before:page;page-break-before:always}@media print{html,body{background-color:#f0f1f5!important}body,table,tbody,tr,td,span,p,a{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;color-adjust:exact!important}.ecw{width:100%!important;min-width:0!important;max-width:none!important}table[width="600"]{width:100%!important}table[style*="max-width:600px"]{max-width:none!important;width:100%!important}table[style*="max-width:552px"]{max-width:none!important;width:100%!important}.export-avoid-break{break-inside:avoid;page-break-inside:avoid}.export-break-before{break-before:page;page-break-before:always}}</style>`;
    ...
    return replaceEvery(
      ...
      .replace(
        `<tr><td dir="ltr" class="ers-fs-213" style="font-size:21.3px;font-weight:700;font-family:Lato, Arial, Helvetica, sans-serif;text-align:left;padding:0px 24px 16px;line-height:1.4;mso-line-height-alt:29.8px"><span style="background-color:#99ff99;white-space:pre-wrap">1.</span><span style="white-space:pre-wrap"> Comprendre : les définitions de l’adaptation</span><br></td></tr>`,
        `${introZeroHtml}<tr><td dir="ltr" class="ers-fs-213" style="font-size:21.3px;font-weight:700;font-family:Lato, Arial, Helvetica, sans-serif;text-align:left;padding:0px 24px 16px;line-height:1.4;mso-line-height-alt:29.8px"><span style="background-color:#99ff99;white-space:pre-wrap">1.</span><span style="white-space:pre-wrap"> Comprendre : les définitions de l’adaptation</span><br></td></tr>`
      )
      .replace(
